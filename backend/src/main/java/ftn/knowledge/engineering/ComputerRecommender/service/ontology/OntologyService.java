...
public interface OntologyService {
    ...
    OWLNamedIndividual getByName(String name, List<OWLNamedIndividual> individuals);

    List<String> upgradeMotherboard(Motherboard motherboard);

    List<String> upgradePowerSupply(PowerSupply powerSupply);

    List<String> upgradeStorage(Storage storage);
    ...
    OWLNamedIndividual getStorageByName(String name);

    OWLNamedIndividual getPowerSupplyByName(String name);
